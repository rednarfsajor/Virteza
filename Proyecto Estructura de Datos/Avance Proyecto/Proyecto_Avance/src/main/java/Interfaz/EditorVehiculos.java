 ...
 * @author Fabián
 */
public class EditorVehiculos extends javax.swing.JFrame {

    /**
     * Creates new form RegistrarVehiculo
     */
    public EditorVehiculos() {
        initComponents();
    }
    ...
    public void SetAuto(Vehiculo auto){
        ...
        COMBOBRANCH.setSelectedItem(auto.getMarca());
        COMBOYEAR.setSelectedItem(auto.getAño());
        COMBOCOLOR.setSelectedItem(auto.getColor());
        COMBOC.setSelectedItem(auto.getCilindrada());
        COMBOFUEL.setSelectedItem(auto.getCombustible());
        COMBOMOUNT.setSelectedItem(auto.getCapacidad());
        TXTMONEY.setText(String.valueOf(auto.getPrecio()));
        TXTEXTRA.setText(auto.getExtras());
        COMBOSTATUS.setSelectedItem(auto.getStatus());
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditorVehiculos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditorVehiculos().setVisible(true);
            }
        });
    }
